      ...
      <div className="custom-image-text-inner" id="secong-image-text">
        <div className="custom-icon-image-inner-flex">
          ...
          <div className="custom-left-content">
            ...
            <button className="custom-btn" onClick={()=> navigate("/sellers", { state: { scrollToCalc: true } })}>Compare 3% vs 5%</button>
            {/* <button className="custom-btn" onClick={() => navigate("/sellers")}>Compare 3% vs 5% →</button> */}
          </div>
