  ...
  return `<!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <title>3PercentAgents API - Backend Dashboard</title>
      ...
      <body>
        <div class="dashboard">
          ...
          <div class="footer">
            <p>© ${new Date().getFullYear()} 3PercentAgents. All rights reserved. | 
            <a href="/health">Health Check</a> | 
            <a href="/status">API Status</a> | 
            <a href="https://github.com/chandamin/NickMenis" target="_blank">GitHub</a></p>
