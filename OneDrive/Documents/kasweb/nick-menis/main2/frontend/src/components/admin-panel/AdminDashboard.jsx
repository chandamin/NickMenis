...
const fetchAgents = useCallback(async () => {
  try {
    ...
    setAgents(
      res.data.map(a => ({
        id: a._id,
        hasActiveLead: a.hasActiveLead,
        activeLeadId: a.activeLeadId,
        name: a.firstName,
        email: a.email,
        joined: a.joinedAt
...
async function assignLead() {
  ...
  function addManualLead() {
    ...
    const newLead = { id: nid, type: 'House', area: 'NewArea', value: 500000, ageDays: 0, summary: 'Manually added lead' };
